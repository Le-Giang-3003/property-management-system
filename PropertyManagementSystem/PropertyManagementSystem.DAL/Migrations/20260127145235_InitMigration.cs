        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicianStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ReasonRejectTechnician = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: false),
                    ReasonRejectLandlord = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: false),
                    TechnicianNote = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PetDetails = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialConditions = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
