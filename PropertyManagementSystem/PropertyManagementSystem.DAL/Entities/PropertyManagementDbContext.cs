...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChatMess__3214EC07C2F629E4");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ChatRoom__3214EC07F49DB6FA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Contract__3214EC07D9174B91");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Files__3214EC07DA6E513E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Invoices__3214EC074BEA58EA");

            entity.ToTable("Invoices", "pm");

            entity.HasIndex(e => e.InvoiceNumber, "UQ__Invoices__D776E981F0651FE4").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Maintena__3214EC07D614BD6F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Maintena__3214EC070D3B43CF");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Payments__3214EC0797B055C1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Properti__3214EC079401F1BB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Property__3214EC074BCAC2B0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__RentalAp__3214EC07A49265F9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__RentalCo__3214EC077D0FC540");

            entity.ToTable("RentalContracts", "pm");

            entity.HasIndex(e => e.ContractNumber, "UQ__RentalCo__C51D43DAAEF2B6A5").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Roles__3214EC071F8C161B");

            entity.ToTable("Roles", "pm");

            entity.HasIndex(e => e.Name, "UQ__Roles__737584F6F6F5C738").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC075FF7F7BA");

            entity.ToTable("Users", "pm");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D1053410528E3A").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UserRole__3214EC0720CEB3A1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ViewingS__3214EC079FB20569");
