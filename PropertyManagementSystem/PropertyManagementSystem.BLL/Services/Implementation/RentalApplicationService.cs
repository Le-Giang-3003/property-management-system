    ...
    public class RentalApplicationService : IRentalApplicationService
    {
        ...
        public async Task<RentalApplication?> SubmitApplicationAsync(CreateRentalApplicationDto dto, int applicantId)
        {
            ...
            var application = new RentalApplication
            {
                ...
                // Handle optional fields: ensure empty string instead of null to avoid database errors
                Employer = dto.Employer ?? string.Empty,
                MonthlyIncome = dto.MonthlyIncome,
                PreviousAddress = dto.PreviousAddress ?? string.Empty,
                PreviousLandlord = dto.PreviousLandlord ?? string.Empty,
                PreviousLandlordPhone = dto.PreviousLandlordPhone ?? string.Empty,
                NumberOfOccupants = dto.NumberOfOccupants,
                HasPets = dto.HasPets,
                PetDetails = dto.PetDetails ?? string.Empty,
                DesiredMoveInDate = dto.DesiredMoveInDate,
                AdditionalNotes = dto.AdditionalNotes ?? string.Empty,
                Status = "Pending",
